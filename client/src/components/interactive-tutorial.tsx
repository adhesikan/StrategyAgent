...
const VCP_TUTORIAL: Tutorial = {
  ...
  steps: [
    ...
    },
    {
      ...
      content: "VCP Trader AI tracks three key stages: FORMING (pattern developing, volatility contracting), READY (pattern mature, approaching breakout point), and BREAKOUT (price breaking above resistance with volume).",
      icon: Target,
      tips: [
...
const SCANNER_TUTORIAL: Tutorial = {
  ...
  steps: [
    ...
    },
    {
      ...
      content: "VCP Trader AI includes strategies across 4 categories: Momentum (VCP, Classic Pullback), Trend (Gap & Go, Trend Continuation), Volatility (Volatility Squeeze, High RVOL), and Intraday (ORB 5min, ORB 15min, VWAP Reclaim).",
      icon: Zap,
      tips: [
  ...
  steps: [
    {
      id: "alerts-types",
      title: "Alert Types",
      content: "VCP Trader AI offers 4 alert types: BREAKOUT (price crosses resistance), STOP HIT (price falls below stop), EMA EXIT (trend reversal signal), and APPROACHING (price nearing key level).",
      icon: Bell,
      tips: [
              ...
              {showTutorialList ? (
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Welcome to VCP Trader AI! Choose a tutorial to get started:
                  </p>
