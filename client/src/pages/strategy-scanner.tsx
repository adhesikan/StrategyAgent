...
const STRATEGIES: Strategy[] = [
  { id: "volume-surge", name: "Volume Surge", type: "Momentum", desc: "Find tickers trading on unusual volume with breaking price levels.", conditions: "Volume > 2× avg", timeframe: "Daily", winRate: 68, icon: Activity, color: "bg-violet-100 text-violet-700" },
  { id: "gap-force", name: "Gap Force", type: "Momentum", desc: "Pre-market gap-up names that hold their open and continue trending.", conditions: "Gap > 2%", timeframe: "Intraday", winRate: 64, icon: Zap, color: "bg-violet-100 text-violet-700" },
  { id: "precision-pullback", name: "Precision Pullback", type: "Trend", desc: "Strong trend pulling back to a key moving average — clean re-entry.", conditions: "Pullback to 20MA", timeframe: "Daily", winRate: 71, icon: TrendingUp, color: "bg-emerald-100 text-emerald-700" },
  { id: "trend-pilot", name: "Trend Pilot", type: "Trend", desc: "Long-term uptrends with rising volume confirmation.", conditions: "Above 50/200MA", timeframe: "Weekly", winRate: 73, icon: LineChart, color: "bg-emerald-100 text-emerald-700" },
  { id: "iv-crush", name: "IV Crush Play", type: "Volatility", desc: "Short premium when implied vol is rich and likely to fall.", conditions: "IV rank > 70", timeframe: "Weekly", winRate: 76, icon: Sparkles, color: "bg-amber-100 text-amber-700" },
  { id: "iron-condor", name: "Iron Condor Hunter", type: "Volatility", desc: "Range-bound names with elevated IV — defined-risk credit setup.", conditions: "Range-bound · IV rank > 60", timeframe: "Monthly", winRate: 78, icon: Target, color: "bg-amber-100 text-amber-700" },
  { id: "opening-range", name: "Opening Range", type: "Intraday", desc: "Breakout above the first 30 minutes of the trading day.", conditions: "ORB break + volume", timeframe: "5-min", winRate: 62, icon: Sun, color: "bg-sky-100 text-sky-700" },
  { id: "vwap-reclaim", name: "VWAP Reclaim", type: "Intraday", desc: "Oversold names reclaiming VWAP with strong order flow.", conditions: "Reclaim VWAP", timeframe: "15-min", winRate: 65, icon: Crosshair, color: "bg-sky-100 text-sky-700" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Pick a strategy. Run a scan. See ranked candidates instantly.
          </p>
        </div>
              ...
              >
                ...
                <div className="col-span-3 md:col-span-1 text-right">
                  <Button
                    ...
                    onClick={() => navigate(`/trade/${r.ticker}?strategy=${selected.id}`)}
